        ...
        <nav class="container mx-auto px-6 md:px-12 py-4" x-data="{ open: false }">
            <div class="md:flex justify-between items-center">
                ...
                <div class="hidden md:flex items-center gap-2">
                    @guest
                        <a href="{{route('register')}}" class="block text-sm text-white cursor-pointer px-4 py-2 rounded-2xl hover:bg-indigo-600">{{__('Register')}}</a>
                        <a href="{{route('login')}}" class="block text-sm text-white cursor-pointer px-4 py-2 rounded-2xl hover:bg-indigo-600">{{__('Login')}}</a>
                    @endguest
                    @auth
                        <a href="{{route('home')}}" class="block text-sm text-white cursor-pointer px-4 py-2 rounded-2xl hover:bg-indigo-600">{{__('Dashboard')}} &rarr; </a>
                    @endauth
...
{{--                    <a class="text-sm uppercase mx-3 text-white cursor-pointer hover:text-indigo-600">Contact us</a>--}}
            ...
            <div x-show="open === true"
                ...
                @guest
                    <a href="{{route('register')}}" class="text-sm text-gray-200 py-2 px-2 hover:bg-indigo-500">{{__('Register')}}</a>
                    <a href="{{route('login')}}" class="text-sm text-gray-200 py-2 px-2 hover:bg-indigo-500">{{__('Login')}}</a>
                @endguest
                @auth
                    <a href="{{route('home')}}" class="text-sm text-gray-200 py-2 px-2 hover:bg-indigo-500">{{__('Dashboard')}}</a>
                @endauth
